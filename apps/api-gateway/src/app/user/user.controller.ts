...
export class UserController {
  ...
  @ApiOperation({ summary: 'Create a new user (super admin, admin)' })
  ...
  @ApiBearerAuth()
  @Roles(Role.SUPERADMIN, Role.ADMIN)
  @ApiOperation({ summary: 'Get user by email (super admin, admin)' })
  ...
  @ApiBearerAuth()
  @Roles(Role.SUPERADMIN, Role.ADMIN)
  @ApiOperation({ summary: 'Get all users with pagination (super admin, admin)' })
  ...
  @ApiBearerAuth()
  @Roles(Role.SUPERADMIN, Role.ADMIN)
  @ApiOperation({ summary: 'Update user by ID (super admin, admin)' })
  ...
  @ApiBearerAuth()
  @Roles(Role.SUPERADMIN, Role.ADMIN)
  @ApiOperation({ summary: 'Delete user by email (super admin, admin)' })
  ...
  @ApiBearerAuth()
  @Roles(Role.SUPERADMIN, Role.ADMIN)
  @ApiOperation({ summary: 'Update user profile by ID (super admin, admin)' })
  ...
  @ApiBearerAuth() 
  @Roles(Role.SUPERADMIN, Role.ADMIN)
  @ApiOperation({ summary: 'Verify user account (super admin, admin)' })
