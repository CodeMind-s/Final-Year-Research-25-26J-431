...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in predictions_pb2_grpc.py depends on'
...
class PredictionsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPredictions = channel.unary_unary(
                '/predictions.PredictionsService/GetPredictions',
...
def add_PredictionsServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'predictions.PredictionsService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('predictions.PredictionsService', rpc_method_handlers)
