...
const WS_URL = __ENV.WS_URL || 'ws://xwh9wjd2-3400.asse.devtunnels.ms/';
...
export function handleSummary(data) {
  ...
  return {
    [`${reportDir}/k6-websocket-${timestamp}.html`]: htmlReport(data, {
      title: 'Vision Service - WebSocket Load Test',
    }),
    [`${reportDir}/k6-websocket-${timestamp}.json`]: JSON.stringify(
      data,
      null,
      2
    ),
